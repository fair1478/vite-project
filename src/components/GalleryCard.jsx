  ...
  return (
    ...
    >
      <CardHeader
        shadow={false}
        floated={false}
        className="col-span-1 mb-4 h-56 md:h-72 lg:h-80 !m-0 !rounded-b-none"
      >
        <Carousel
          key={id}
          loop={true}
      ...
      <div
        className="lg:col-span-2 flex flex-col h-fit hover:cursor-pointer active:cursor-progress py-6 w-full"
        onClick={onClick}
      >
        <CardBody className="flex-grow flex flex-col justify-start py-0 2xl:px-6 w-full">
          <div className="flex flex-col gap-1 mb-2">
            <Typography className="!text-h3 !line-clamp-1 text-[#131D10] h-[22px] 2xl:h-[24px]">
              {title}
            </Typography>
            <div className="flex flex-col gap-x-1 items-start mb-2 lg:mb-4">
          ...
          <Typography className="!text-sm lg:!text-body1 !line-clamp-2 lg:!line-clamp-3 text-[#60675E] h-10 lg:h-[66px]">
            {subtitle}
          </Typography>
